...
function out = get_hess_predictive(f, ab1, ab2, ab3, ab4, ns1, ns2, ns3, ns4, C1, C2, C3, C4, Sigmainv)
    out = -Sigmainv - ...
        (get_hess_predictive0(f, ab1, ns1, C1) + ...
        get_hess_predictive0(f, ab2, ns2, C2) + ...
        get_hess_predictive0(f, ab3, ns3, C3) + ...
        get_hess_predictive0(f, ab4, ns4, C4));
end

function out = get_hess_predictive0(f,ab,ns,C)
    out = C' * get_grad_predictive0(f,ab,ns,C);
end